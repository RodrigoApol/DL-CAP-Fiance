...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "com/capfiance/movements/types/appmovementstypes/test/integration/MovementTypeListJourney.gen",
    "com/capfiance/movements/types/appmovementstypes/test/integration/MovementTypeObjectPageJourney.gen",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
