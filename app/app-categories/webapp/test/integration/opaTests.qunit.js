...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "com/capfiance/category/appcategories/test/integration/CategoriesListJourney.gen",
    "com/capfiance/category/appcategories/test/integration/CategoriesObjectPageJourney.gen",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
