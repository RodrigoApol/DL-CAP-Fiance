...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Check filter bar", function (Given, When, Then) {
            Then.onTheCategoriesListGenerated.onFilterBar().iCheckFilterField("Nome");
        });
        ...
        opaTest("Check table columns and actions", function (Given, When, Then) {
            Then.onTheCategoriesListGenerated.onTable().iCheckColumns(undefined, {"name":{"header":"Nome"},"icon":{"header":"Ícone"}});
