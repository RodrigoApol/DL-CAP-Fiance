...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("WallatsListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onTheWallatsListGenerated.iSeeThisPage();
        });

        opaTest("Check filter bar", function (Given, When, Then) {
            Then.onTheWallatsListGenerated.onFilterBar().iCheckFilterField("Nome");
        });
        ...
        //     When.onTheWallatsListGenerated.onFilterBar().iChangeSearchField("Search Term");
        ...
        opaTest("Check table columns and actions", function (Given, When, Then) {
            Then.onTheWallatsListGenerated.onTable().iCheckColumns(undefined, {"name":{"header":"Nome"}});
