...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("WalletsListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onTheWalletsListGenerated.iSeeThisPage();
        });

        opaTest("Check filter bar", function (Given, When, Then) {
            Then.onTheWalletsListGenerated.onFilterBar().iCheckFilterField("Nome");
        });
        ...
        //     When.onTheWalletsListGenerated.onFilterBar().iChangeSearchField("Search Term");
        ...
        opaTest("Check table columns and actions", function (Given, When, Then) {
            Then.onTheWalletsListGenerated.onTable().iCheckColumns(undefined, {"name":{"header":"Nome"}});
