...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "com/capfiance/movement/appmovements/test/integration/MovementsListJourney.gen",
    "com/capfiance/movement/appmovements/test/integration/MovementsObjectPageJourney.gen",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
