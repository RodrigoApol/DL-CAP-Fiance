...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("MovementsListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onTheMovementsListGenerated.iSeeThisPage();
        });

        opaTest("Check filter bar", function (Given, When, Then) {
            Then.onTheMovementsListGenerated.onFilterBar().iCheckFilterField("Nome");
        });
        ...
        //     When.onTheMovementsListGenerated.onFilterBar().iChangeSearchField("Search Term");
        ...
        opaTest("Check table columns and actions", function (Given, When, Then) {
            Then.onTheMovementsListGenerated.onTable().iCheckColumns(undefined, {"name":{"header":"Nome"},"amount":{"header":"Valor"},"date":{"header":"Data"},"type_name":{"header":"Tipo"},"wallet_name":{"header":"Carteira"},"category_name":{"header":"Categoria"},"note":{"header":"Anotação"}});
